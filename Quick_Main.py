...
Original file is located at
    https://colab.research.google.com/drive/10XKUW-MOQTuFWlIPtNHcOQkSgBfLH9V-
...
# %cd drive/MyDrive/Projects/author\ clustering
...
eval_dir="./data/pan17-author-clustering-test-dataset-2017-03-14"
out_dir="./data/tfidf_weight_x_word2vec_output_pan17-author-clustering-test-dataset-2017-03-14"

dict_f=info(eval_dir)  
dict_f=sortedcollections.OrderedDict(sorted(dict_f.items()))

en_=open("./data/english_weighted.json",'r')
dt_=open("./data/dutch_weighted.json",'r')
gr_=open("./data/greek_weighted.json",'r')
